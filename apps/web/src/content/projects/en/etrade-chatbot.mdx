...
<Image src="/images/projects/etrade-chatbot/Etrade.png" width={150} height={75} alt="The E*Trade chatbot handled common questions instantly, reducing wait times." />
...
<Image src="/images/projects/etrade-chatbot/Etrade2.png" width={600} height={400} alt="Shifting simple requests from phones to chat." />
...
<Image src="/images/projects/etrade-chatbot/UI_templates_support.png" width={400} height={600} alt="Ensuring every user could navigate the tool easily." />
...
<Image src="/images/projects/etrade-chatbot/Fallback_Flow.png" width={600} height={400} alt="Balancing automation with human help when needed." />
...
<Image src="/images/projects/etrade-chatbot/metrics.png" width={600} height={400} alt="Filling content gaps based on real user data." />
...
<Image src="/images/projects/etrade-chatbot/Etrade.png" width={400} height={600} alt="Rewriting answers to be clear and approachable." />
...
<Image src="/images/projects/etrade-chatbot/UI_templates_support.png" width={400} height={600} alt="Iterating on UI elements for clarity." />
...
<Image src="/images/projects/etrade-chatbot/Live_Agent_support.png" width={400} height={600} alt="Mapping workflows to keep interactions smooth." />
...
<Image src="/images/projects/etrade-chatbot/metrics.png" width={600} height={400} alt="Fewer calls meant faster service for complex issues." />
